...
public class MainSerialization {
    ...
    public static void main(String[] args) {
        ...
        Hall hall2 = new Hall(2, 100);

        Screening screening1 = new Screening(inception, hall1, LocalDate.now().plusDays(1));
        Screening screening2 = new Screening(interstellar, hall2, LocalDate.now().plusDays(2));
        Screening screening3 = new Screening(soul, hall1, LocalDate.now().plusDays(3));
