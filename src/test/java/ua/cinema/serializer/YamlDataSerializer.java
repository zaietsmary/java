...
class YamlDataSerializerTest {
    ...
    private static final String TEST_FILE = "test_movies.yaml";
    private YamlDataSerializer<Movie> serializer;
    ...
    @Test
    @DisplayName("Серіалізація і десеріалізація YAML повинні зберігати ті ж самі дані")
    void testSerializeAndDeserialize() throws DataSerializationException {
        ...
        assertEquals(originalMovies, deserializedMovies, "Дані після десеріалізації YAML не збігаються!");
    }

    @Test
    @DisplayName("Повинно викидати виняток при читанні неіснуючого YAML файлу")
    void testDeserializeInvalidFile() {
        assertThrows(DataSerializationException.class, () ->
                serializer.deserialize("nonexistent_file.yaml", Movie.class)
        );
    }

    @Test
    @DisplayName("Повинно викидати виняток при спробі серіалізувати null у YAML")
